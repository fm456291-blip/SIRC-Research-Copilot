...
function App() {
  ...
  // NOTE: DashboardApp ab neeche ek ALAG component ke tor par
  // define hai, isi liye yeh kaam karega.
  return <DashboardApp user={user} setUser={setUser} />;
}

// =====================================================
// DASHBOARD APP
// (Pehle yeh sab code App() ke andar, return ke NEECHE
// pada tha, isi liye kabhi chalta hi nahi tha aur
// "DashboardApp is not defined" error deta tha.)
// =====================================================
function DashboardApp({ user, setUser }) {
  // =====================================================
  // NOTE: neeche diye gaye states aapke bheje gaye code
  // mein nazar nahi aaye (paste mein miss ho gaye honge),
  // lekin poori file mein use ho rahe hain, isi liye yahan
  // add kiye hain. Agar aapke asal file mein already yeh
  // states kahin declare thay to unhe replace kar dein.
  // =====================================================
  ...
  const sircStaff = [
    ...
    },
    {
      name: "Mr. Turaj Iqbal",
      role: "Officer",
      keywords: ["turaj", "turaj iqbal", "officer"],
      description:
...
`;
  ...
  const searchResearchRepository = async (topic) => {
    ...
    try {
      ...
      const resources = Array.isArray(data.resources)
        ? data.resources
        : [];
      setRepositoryTopic(data.topic || topic.trim());
  ...
  // =====================================================
  // PDF ANALYSIS (fetch helper)
  // =====================================================
  const analyzePDF = async (file, action, question) => {
    ...
    if (!response.ok) {
      throw new Error(
        data.error || "Unable to analyze the PDF."
      );
    }
...
`;
          ...
          if (recommendationData.count > 10) {
            repositorySection += `
> **${
              recommendationData.count - 10
            } additional related resources** are also available in the SIRC Research Repository.
`;
          }
...
`;
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // AI RESPONSE
      // =================================================
      const result = await sendNormalMessage(
        currentMessage
      );
      setMessages((previous) => [
        ...previous,
      ...
      // REPOSITORY SEARCH
      // =================================================
      if (result.shouldSearchRepository) {
        await searchResearchRepository(currentMessage);
      }
    } catch (error) {
      console.error("SIRC Copilot Error:", error);
      setMessages((previous) => [
        ...previous,
        {
          type: "assistant",
  ...
  // =====================================================
  const handleLogout = () => {
    localStorage.removeItem("sirc_user");
    setUser(null);
  };
  ...
  const handleDocumentAction = async (action) => {
    ...
    const actionName =
      actionNames[action] || "Analyze Document";
    const currentFile = selectedFile;
    ...
    try {
      ...
      setMessages((previous) => [
        ...
        {
          type: "assistant",
          text: answer || "No response was generated.",
        },
      ]);
      setSelectedFile(null);
      if (fileInputRef.current) {
    ...
    <div className="app">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-section">
          <p>Research Tools</p>
          <button onClick={() => handleSidebarTool("topic")}>
            🔎 Research Topic
          </button>
          <button
            onClick={() => handleSidebarTool("questions")}
          >
            🧠 Research Questions
          </button>
          <button
            onClick={() => handleSidebarTool("keywords")}
          >
            🔤 Keywords & Synonyms
          </button>
          <button
            onClick={() => handleSidebarTool("boolean")}
          >
            🔗 Boolean Search
          </button>
          <button
            onClick={() => handleSidebarTool("database")}
          >
            📚 Database Guide
          </button>
          <button
            onClick={() => handleSidebarTool("citation")}
          >
            📑 Citation Help
          </button>
        </div>
      ...
      <main className="main">
        ...
        {messages.length === 0 && (
          <section className="welcome">
            ...
            <p>
              Research smarter, discover better, and get
              academic assistance whenever you need it.
            </p>
            <div className="quick-tools">
              <button
                className="tool-card"
                onClick={() => handleSidebarTool("topic")}
              >
                <span>🔎</span>
                <h3>Research Topics</h3>
                <p>Develop and refine research ideas.</p>
              </button>
              <button
                className="tool-card"
                onClick={() =>
              ...
              >
                <span>🔤</span>
                <h3>Keywords</h3>
                <p>Find keywords and useful synonyms.</p>
              </button>
              <button
                className="tool-card"
                onClick={() =>
              ...
              >
                ...
                <p>Create powerful database searches.</p>
              </button>
              <button
                className="tool-card"
                onClick={() =>
              ...
              >
                ...
                <p>Find the right database for your topic.</p>
              </button>
            </div>
          </section>
        )}
          ...
          <section className="messages">
                ...
                <div className="repository-section">
                  <div className="repository-header">
                    <div>
                      ...
                      <h3>Related Resources Available</h3>
                      <p>
                        We found{" "}
                        <strong>
            ...
            {!repositoryLoading && repositoryError && (
              <div className="repository-error">
                <strong>SIRC Research Repository</strong>
                <p>
                  Repository search could not be completed
                  at the moment.
                </p>
              </div>
            )}
          ...
          <div className="document-actions">
            <div className="document-actions-header">
              <div className="document-info">
                ...
                <span>
                  Ask anything about this document or
                  choose an action.
                </span>
              </div>
              <button
            ...
            <div className="document-action-grid">
              ...
              >
                <span>🔎</span>
                <div>
                  <strong>Find Research Gap</strong>
                  <small>Identify possible gaps</small>
                </div>
              </button>
              <button
                onClick={() =>
              ...
              >
                <span>🎯</span>
                <div>
                  <strong>Extract Objectives</strong>
                  <small>Find research objectives</small>
                </div>
              </button>
              <button
                onClick={() =>
              ...
              >
                <span>🧪</span>
                <div>
                  <strong>Explain Methodology</strong>
                  <small>Understand the methods</small>
                </div>
              </button>
              <button
                onClick={() =>
              ...
              >
                ...
                <div>
                  ...
                  <small>Extract important findings</small>
                </div>
              </button>
              <button
                onClick={() =>
              ...
              >
                ...
                <div>
                  ...
                  <small>Create research questions</small>
                </div>
              </button>
            </div>
          </div>
        ...
        <section className="chat-area">
          ...
          <p className="disclaimer">
            ...
            research and information discovery. Always
        ...
        >
          ...
          >
            ...
            <div className="about-hero">
              <div className="about-brand-icon">S</div>
              <div>
                ...
                <p>
                  ...
                  and building a culture of knowledge
                  through modern library services and
                  technology.
                </p>
              </div>
            </div>
            ...
            <section className="about-section">
              <div className="section-heading">
                ...
                <div>
                  <h2>Who We Are</h2>
                  <p>
                    About Superior Information Resource
                    Center
                  </p>
                </div>
              </div>
            ...
            <section className="copilot-about">
              ...
              <div className="copilot-content">
                <span>SIRC TECHNOLOGY INITIATIVE</span>
                <h2>SIRC Research Copilot</h2>
                <p>
